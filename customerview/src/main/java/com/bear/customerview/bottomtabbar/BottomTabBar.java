package com.bear.customerview.bottomtabbar;
...
import com.bear.customerview.bottomtabbar.custom.CustomFragmentTabHost;
import com.bear.customerview.bottomtabbar.util.TintUtil;
...
public class BottomTabBar extends LinearLayout {
    ...
    public void setSelectTab(int select){
        mTabHost.setCurrentTab(select);
    }
     ...
     * @return
     */
    public BottomTabBar addTabItem(String name, int imgId,int selectImage,Class fragmentClass) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgId),ContextCompat.getDrawable(context,selectImage),fragmentClass);
    }
     ...
     * @return
     */
    public BottomTabBar addTabItem(final String name, Drawable drawable,Drawable selectDrawable,Class fragmentClass) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec(TextUtils.isEmpty(name) ? fragmentClass.getName() : name)
                .setIndicator(getTabItemView(TextUtils.isEmpty(name) ? fragmentClass.getName() : name, drawable,selectDrawable)), fragmentClass, null);
        return this;
    }
    private View getTabItemView(String name, Drawable drawable,Drawable selectDrawable) {
...
//        iv.setLayoutParams(ivParams);
        iv.setImageDrawable(TintUtil.setStateListTintDrawable(drawable,selectDrawable));
