package com.bear.customerview.carouseview;
...
/**
 * Created by liuyuxing on 2017/3/23 0023.
 */
/**
 ...
 * strokeWidth                                    边框的宽度
 */
public class CarouseEditText extends EditText{

    private StateListDrawable selector;
    private int radius;
    private int strokeWidth = 2;

    public CarouseEditText(Context context) {
        super(context);
    }

    public CarouseEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributeSet(context, attrs);
    }

    public CarouseEditText(Context context, AttributeSet attrs, int defStyleAttr) {
