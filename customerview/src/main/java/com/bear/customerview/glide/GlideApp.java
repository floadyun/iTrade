...
public class GlideApp {
    ...
    public void with(Context context, int placeIcon, String path, final ImageView imageView) {
        glideUtil.with(context, placeIcon, path, imageView);
    }
     ...
     * @param imageView    图片控件
     */
    public void with(Context context, int resourceIcon, final ImageView imageView) {
        glideUtil.with(context, resourceIcon, imageView);
    }
    ...
    private class GlideUtil {
         ...
         * @param imageView 图片控件
         */
        private void with(Context context, int placeIcon, String path, final ImageView imageView) {
         ...
         * @param imageView    图片控件
         */
        private void with(Context context, int resourceIcon, final ImageView imageView) {
            // 调用glide显示图片：
            Glide.with(context).load(resourceIcon).into(imageView);
        }
