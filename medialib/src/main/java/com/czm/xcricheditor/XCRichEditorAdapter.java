...
public class XCRichEditorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        if(viewType == ITEM_TYPE.ITEM_TYPE_IMAGE.ordinal()){
            View view = mLayoutInflater.inflate(R.layout.rich_item_image_component, viewGroup, false);
            ImageViewHolder holder = new ImageViewHolder(view);
            return holder;
        }else{
            View view = mLayoutInflater.inflate(R.layout.rich_item_text_component, viewGroup, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(Uri uri) {
            Glide.with(mContext).load(uri.getEncodedPath()).into(img);
